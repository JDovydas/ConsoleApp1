using _36_Paskaita_Restaurant_System.Helpers;
...
using _36_Paskaita_Restaurant_System.Sensitive;
...
namespace _36_Paskaita_Restaurant_System
{
    internal class WaitressUi
    {
        ...
        public string filePath = "C:\\Users\\djuod\\source\\repos\\ConsoleApp1\\36_Paskaita_Restaurant_System\\Data\\food.txt";
        ...
        public void updateProductFile(string productName, decimal productPrice)
        {
            try
            {
                using (StreamWriter sw = new StreamWriter("C:\\Users\\djuod\\source\\repos\\ConsoleApp1\\36_Paskaita_Restaurant_System\\Data\\food.txt", true))
                {
        ...
        private void SaveOrderToFile(Order order)
        {
            try
            {
                using (StreamWriter sw = new StreamWriter("C:\\Users\\djuod\\source\\repos\\ConsoleApp1\\36_Paskaita_Restaurant_System\\Data\\Orders.txt", true))
                {
        ...
        {
            string voucherFolder = @"C:\Users\djuod\source\repos\ConsoleApp1\36_Paskaita_Restaurant_System\Data\vouchers";
        ...
        public void SendVoucherViaEmail(Order newOrder, string emailAddress)
        {
            ...
            //emailMessage.Body = new TextPart("plain") { Text = $"{newOrder.ToString()}\n\nThanks for visiting - and looking forward to seeing you again!" };
            ...
            try
            {
                using (var client = new MailKit.Net.Smtp.SmtpClient())
                {
                    ...
                    Console.WriteLine("Voucher sent successbully");

...
namespace _36_Paskaita_Restaurant_System
{
    internal class WaitressUi
    {
        ...
        public string filePath = "C:\\Users\\djuod\\source\\repos\\ConsoleApp1\\Paskaita_36_Another_Saved_Version\\Data\\food.txt";
        ...
        public void updateProductFile(string productName, decimal productPrice)
        {
            try
            {
                using (StreamWriter sw = new StreamWriter("C:\\Users\\djuod\\source\\repos\\ConsoleApp1\\Paskaita_36_Another_Saved_Version\\Data\\food.txt", true))
                {
        ...
        private void SaveOrderToFile(Order order)
        {
            try
            {
                using (StreamWriter sw = new StreamWriter("C:\\Users\\djuod\\source\\repos\\ConsoleApp1\\Paskaita_36_Another_Saved_Version\\Data\\Orders.txt", true))
                {
        ...
        {
            string voucherFolder = @"C:\Users\djuod\source\repos\ConsoleApp1\Paskaita_36_Another_Saved_Version\Data\vouchers";

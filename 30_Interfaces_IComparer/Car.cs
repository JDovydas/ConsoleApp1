...
namespace _30_Interfaces_IComparer
{
    public class Car : IVehicle
    {
        ...
        public string Model { get; set; } // public starts with Capital letter, private - _model (underscore + lowecase);
        public int Fuel { get; set; }
        public int MaxFuelCapacity { get; set; } = 50; //can be overrwitten

        public Car(string model, int fuel, int maxFuelCapacity)
        ...
        public void Refuel(int fuel)
        {
            ...
            {
                Console.WriteLine("ERROR: You cannot refuel a negative amount of fuel");
            }
            else
            {

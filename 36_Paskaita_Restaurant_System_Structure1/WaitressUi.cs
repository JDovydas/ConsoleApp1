using _36_Paskaita_Restaurant_System_Structure1.Helpers;
using MimeKit;
...
using _36_Paskaita_Restaurant_System_Structure1.Sensitive;
...
namespace _36_Paskaita_Restaurant_System_Structure1
{
    internal class WaitressUi
    {
        ...
        public void StartNewOrder(List<Product> products)
        {
            using (var dbContext = new OrderContext())
            {
                var freeTables = dbContext.Tables.Where(table => !table.IsOccupied).ToList();
                ...
                if (int.TryParse(Console.ReadLine(), out int tableNumber))
                {
                    ...
                    if (selectedTable != null)
                    {
                        ...
                        dbContext.Orders.Add(newOrder); // Add the new order to DbSet
